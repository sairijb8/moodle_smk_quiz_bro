...
import id.sch.smkn1banjarbaru.browsermoodleapp.BuildConfig;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtVersi = findViewById(R.id.txt_versi);
        txtPesan = findViewById(R.id.txt_pesan);
        txtVersi.setText("Versi "+BuildConfig.VERSION_NAME);
        if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(MainActivity.this, new String[] {Manifest.permission.CAMERA}, 123);
            txtPesan.setText("Izin kamera ditolak, hidupkan izin kamera untuk melanjutkan aplikasi");
        } else {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (hasil==200){
                            ...
                            Toast.makeText(MainActivity.this, "Bukan QR yang tepat, silahkan scan ulang", Toast.LENGTH_SHORT).show();
                        }
